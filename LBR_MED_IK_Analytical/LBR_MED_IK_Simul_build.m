...
% Let's use Config 3 from validation as a test target
p_des = [-0.926; 0; 0.340];
R_des = [1 0 0; 0 0 -1; 0 1 0]; % Matches RX(pi/2) as derived earlier
...
% We can use the matlabFunctionBlock generated for Point 2
% or recreate it here.
Robot = LBR_MED();
T = DKin(Robot);
R_sym = T(1:3, 1:3);
...
Simulink.connectBlocks([ikBlk '/1'], [dkBlk '/1']);
